...
Neste exercício, foi utilizado recurso de aprendizado de máquina automatizado no Azure Machine Learning para treinar e avaliar um modelo de aprendizado de máquina. 
...
Fonte de dados :
Selecione Dos arquivos da web URL da Web :
